...
# SOLVER_CHECKPOINT_PERIOD = 5000     # default: 5000
# SOLVER_IMS_PER_BATCH = 2            # default: 16
# SOLVER_MAX_ITER = 48000             # default: 6000 (default STEPS: (4000, ))
MAX_CKPT = 5
MASTER_CMD_PREFIX = ""
...
if __name__ == "__main__":
    ...
    # platform
    parser.add_argument('--tx', action='store_true', help='set TX=1')
    parser.add_argument('--titan', action='store_true', help='set TITAN=1')
    args = parser.parse_args()

    assert args.tx + args.titan <= 1
